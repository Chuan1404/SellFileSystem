...
public class AuthenticationService {
    ...
    public void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException {
        ...
        String content = "Kính gửi [[name]],<br><br>"
                ...
                + "Trải nghiệm của khách hàng chính là động lực to lớn nhất của chúng tôi và nhất định chúng tôi sẽ mang đến cho bạn trải nghiệm tốt nhất. "
                ...
                + "Một lần nữa cảm ơn bạn và đừng quên xác nhận tài khoản của bạn bằng link bên dưới để trải nghiệm dịch vụ:<br>"
